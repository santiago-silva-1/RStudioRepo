...
#IrishFamine3=data.frame()
for (page_result in seq(from =3418, to= 3600, by=1)) {
...
IrishFamine3=rbind(IrishFamine3 , data.frame(LastName=LastName,FirstName=FirstName , Age= Age, NativeCountryCode= NativeCtryCode,
                                       Destination= Destination, PassengerPortOfEmbarkationCode= PortofEmbark, 
                                       ManifestIdentificationNumber=ManifestNum , 
...
##IrishFamine2 goes from page 2401 to 3600, lost 150 obs
...
openxlsx::write.xlsx(IrishFamine3, file = "PeopleWhoMigratedpart3.xlsx")
