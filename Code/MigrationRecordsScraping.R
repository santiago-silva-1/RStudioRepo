...
#IrishFamine4=data.frame()
for (page_result in seq(from =4797, to= 4800, by=1)) {
...
IrishFamine4=rbind(IrishFamine4 , data.frame(LastName=LastName,FirstName=FirstName , Age= Age, NativeCountryCode= NativeCtryCode,
                                       Destination= Destination, PassengerPortOfEmbarkationCode= PortofEmbark, 
                                       ManifestIdentificationNumber=ManifestNum , 
...
openxlsx::write.xlsx(IrishFamine4, file = "PeopleWhoMigratedpart4.xlsx")
